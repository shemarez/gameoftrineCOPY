...
SideScroller.Game.prototype = {
  ...
  create: function() {
    ...
    this.map.addTilesetImage('sea', 'sea');
    this.map.addTilesetImage('sky', 'sky');
    this.map.addTilesetImage('fargrounds', 'fargrounds');
    // this.map.addTilesetImage('clouds', 'clouds');
    ...
    //create layers
    this.backgroundlayer = this.map.createLayer('background1');
    this.cloudsLayer = this.map.createLayer('clouds');
    // this.decorationsLayer = this.map.createLayer('')

    this.blockedLayer = this.map.createLayer('collisions');

    //collision on blockedLayer
    this.map.setCollisionBetween(1, 5000, true, 'collisions');

    //resizes the game world to match the layer dimensions
    this.backgroundlayer.resizeWorld();
    this.cloudsLayer.resizeWorld();
